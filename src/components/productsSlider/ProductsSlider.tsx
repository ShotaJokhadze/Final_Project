  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center justify-center w-4/5 mx-auto gap-6">
      {products.map((product) => (
        <div 
          key={product.id} 
          className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md sm:mx-2 hover:shadow-lg w-full h-[500px]"
        >
          ...
          <div className="flex flex-col h-1/2 justify-between space-y-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-zinc-100 line-clamp-2 min-h-[46px]">{locale==='ka' ? product.title_ge : product.title}</h3>
